...
class SolicitudPeriodoExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    /**
    ...
    */
    ...
    public function collection()
    {
	  ...
	  ,[diasTranscurridos]
	  ,[nombre_usuario]
        FROM [listarSolicitudes] WHERE CAST(created_at AS DATE) BETWEEN ? AND ?", [$this->start_date, $this->end_date]));
    }
