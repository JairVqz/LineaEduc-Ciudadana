...
class SolicitudDiaExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    /**
    ...
    */
    public function collection()
    {
	  ...
	  ,[diasTranscurridos]
	  ,[nombre_usuario]
        FROM [listarSolicitudes] WHERE CAST(created_at AS DATE) = CAST(GETDATE() AS DATE)'));
    }
