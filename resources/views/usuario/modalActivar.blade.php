            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3 d-flex flex-column">
                        <h5 class="text-center">¿Estás seguro de activar el usuario: {{ $usuario->name }}?</h5>
                        <h5 class="text-center" style="font-weight: normal">El usuario será habilitado nuevamente para
